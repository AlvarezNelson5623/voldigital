...
VALUES
(1, 'Natalia', 'Gómez', 'Apasionada por la conservación ambiental.', '+573001111111','Bucaramanga','1992-04-12'),
(2, 'Carlos', 'Ramírez', 'Docente voluntario en educación popular.', '+573002222222','Bucaramanga','1988-09-03'),
(3, 'María', 'López', 'Diseñadora gráfica que colabora con ONGs.', '+573003333333','Floridablanca','1995-07-21'),
(4, 'Juan', 'Pérez', 'Programador interesado en tecnología social.', '+573004444444','Bucaramanga','1990-01-10'),
(5, 'Ana', 'Martínez', 'Líder comunitaria en proyectos de nutrición.', '+573005555555','Bucaramanga','1985-12-30'),
(6, 'Luis', 'Fernández', 'Estudiante universitario, trabaja en programas comunitarios.', '+573006666666','Bucaramanga','2000-06-15'),
(7, 'Sofía', 'Ruiz', 'Gestora cultural y voluntaria en arte.', '+573007777777','Floridablanca','1993-11-02'),
(8, 'Andrés', 'García', 'Deportista y promotor de bienestar.', '+573008888888','Bucaramanga','1991-03-19'),
(9, 'Laura', 'Rojas', 'Enfermera voluntaria en campañas de salud.', '+573009999999','Bucaramanga','1987-08-25'),
(10,'Diego', 'Suárez', 'Emprendedor social en formación.', '+573010000000','Bucaramanga','1994-02-14');

-- Variables con los IDs reales de la tabla `volunteers` (FK requiere volunteers.id)
SELECT id INTO @vol1 FROM volunteers WHERE user_id=1 LIMIT 1;
SELECT id INTO @vol2 FROM volunteers WHERE user_id=2 LIMIT 1;
SELECT id INTO @vol3 FROM volunteers WHERE user_id=3 LIMIT 1;
SELECT id INTO @vol4 FROM volunteers WHERE user_id=4 LIMIT 1;
SELECT id INTO @vol5 FROM volunteers WHERE user_id=5 LIMIT 1;
SELECT id INTO @vol6 FROM volunteers WHERE user_id=6 LIMIT 1;
SELECT id INTO @vol7 FROM volunteers WHERE user_id=7 LIMIT 1;
SELECT id INTO @vol8 FROM volunteers WHERE user_id=8 LIMIT 1;
SELECT id INTO @vol9 FROM volunteers WHERE user_id=9 LIMIT 1;
SELECT id INTO @vol10 FROM volunteers WHERE user_id=10 LIMIT 1;
...
VALUES
(11, 'Guardianes del Río', 'Actividades de conservación y reforestación (medio ambiente).', '+573011111111','Calle 100 #10-10','Bucaramanga','https://guardianesrio.org', 1, 1, CURDATE()),
(12, 'Abuelos en Casa', 'Programas de acompañamiento y cuidado para adultos mayores.', '+573012222222','Carrera 15 #20-30','Bucaramanga','https://abuelosencasa.org', 2, 4, CURDATE()),
(13, 'Fiesta Social', 'Organización de eventos sociales y comunitarios.', '+573013333333','Avenida 9 #33-21','Floridablanca','https://fiestasocial.org', 3, 6, CURDATE()),
(14, 'Refugio Peludo', 'Refugio y adopción para animales en situación de calle.', '+573014444444','Diagonal 5 #11-50','Bucaramanga','https://refugiopeludo.org', 4, 8, CURDATE()),
(15, 'Cultura Viva', 'Proyectos culturales, talleres y festivales.', '+573015555555','Calle 22 #44-10','Bucaramanga','https://culturaviva.org', 3, 5, CURDATE());
...
VALUES
(1, 'Limpieza Río Verde', 'Jornada de limpieza y reforestación en la cuenca del Río Verde.', '', 'Parque Río Verde', 20, 'recruiting', '2026-06-05', NULL);
SET @p_o1_1 = LAST_INSERT_ID();

/* Org2 (plan 2) -> 4 proyectos */
INSERT INTO projects (organization_id, title, description, image_url, location, max_volunteers, status, start_date, end_date)
VALUES
(2, 'Aula Intergeneracional 2026', 'Actividades educativas y recreativas enfocadas en adultos mayores y la comunidad (intergeneracional).', '', 'Centro Comunitario', 30, 'completed', '2026-01-10', '2026-03-15'),
(2, 'Biblioteca Comunitaria', 'Recolección y catalogación de libros.', '', 'Centro Comunitario', 10, 'recruiting', '2026-05-20', NULL),
(2, 'Taller de Habilidades Digitales', 'Formación básica en uso de dispositivos y comunicación digital para adultos mayores.', '', 'Centro Comunitario', 12, 'recruiting', '2026-07-01', NULL),
(2, 'Campaña Nutricional', 'Charlas y talleres de nutrición.', '', 'Colegio San José', 15, 'completed', '2025-11-01', '2026-02-01');
...
INSERT INTO projects (organization_id, title, description, image_url, location, max_volunteers, status, start_date, end_date)
VALUES
(3, 'Festival de Arte', 'Eventos y talleres para jóvenes artistas.', '', 'Plaza Principal', 25, 'completed', '2025-09-05', '2025-12-10'),
(3, 'Muestra Cultural', 'Exposición y actividades culturales.', '', 'Casa de la Cultura', 20, 'recruiting', '2026-08-01', NULL),
(3, 'Residencia Artística', 'Programa de residencia para creadores.', '', 'Talleres Arte Viva', 6, 'recruiting', '2026-09-10', NULL),
(3, 'Taller de Teatro', 'Formación teatral comunitaria.', '', 'Teatro Local', 18, 'recruiting', '2026-06-15', NULL),
(3, 'Murales por la Paz', 'Intervenciones artísticas en espacios públicos.', '', 'Barrios', 10, 'completed', '2026-02-01', '2026-04-01'),
(3, 'Círculo de Lectura', 'Club de lectura y discusión.', '', 'Biblioteca Arte Viva', 12, 'recruiting', '2026-05-25', NULL);
...
INSERT INTO projects (organization_id, title, description, image_url, location, max_volunteers, status, start_date, end_date)
VALUES
(4, 'Programa Emprende', 'Acompañamiento a emprendimientos sociales.', '', 'Centro Empresarial', 40, 'completed', '2025-06-01', '2025-10-01'),
(4, 'Laboratorio de Innovación', 'Prototipado con comunidades.', '', 'Lab Impulso', 20, 'recruiting', '2026-06-20', NULL),
(4, 'Mentoría Profesional', 'Mentorías para jóvenes líderes.', '', 'Oficinas', 15, 'completed', '2026-01-15', '2026-03-20'),
(4, 'Campaña de Salud', 'Jornadas de salud preventiva.', '', 'Plaza Salud', 30, 'completed', '2026-02-10', '2026-04-10'),
(4, 'Foro Empresarial', 'Eventos y networking con impacto social.', '', 'Auditorio', 50, 'recruiting', '2026-09-05', NULL),
(4, 'Capacitación Técnica', 'Cursos técnicos para la comunidad.', '', 'Centro de Formación', 25, 'recruiting', '2026-07-01', NULL),
(4, 'Voluntariado Corporativo', 'Proyectos cortos con empleados.', '', 'Sedes', 60, 'recruiting','2026-05-10', NULL),
(4, 'Evaluación de Impacto', 'Medición de proyectos sociales.', '', 'Oficinas Centrales', 8, 'recruiting', '2026-06-01', NULL);
...
INSERT INTO projects (organization_id, title, description, image_url, location, max_volunteers, status, start_date, end_date)
VALUES
(5, 'Talleres Comunitarios', 'Series de talleres abiertos de música, danza y creación.', '', 'Centro Cultural', 20, 'completed', '2026-01-10', '2026-03-01'),
(5, 'Festival Callejero', 'Actividades artísticas al aire libre para toda la comunidad.', '', 'Plaza Central', 30, 'recruiting', '2026-09-10', NULL),
(5, 'Residencia de Artistas', 'Alojamiento y apoyo a artistas emergentes.', '', 'Casa de la Cultura', 8, 'recruiting', '2026-07-15', NULL),
(5, 'Ciclo de Conciertos', 'Conciertos comunitarios con artistas locales.', '', 'Parque Cultural', 40, 'recruiting', '2026-08-20', NULL);
...
UPDATE volunteers SET avatar_url='https://i.pravatar.cc/150?img=1', banner_url='https://picsum.photos/seed/v1/1200/300' WHERE id=1;
UPDATE volunteers SET avatar_url='https://i.pravatar.cc/150?img=2', banner_url='https://picsum.photos/seed/v2/1200/300' WHERE id=2;
UPDATE volunteers SET avatar_url='https://i.pravatar.cc/150?img=3', banner_url='https://picsum.photos/seed/v3/1200/300' WHERE id=3;
UPDATE volunteers SET avatar_url='https://i.pravatar.cc/150?img=4', banner_url='https://picsum.photos/seed/v4/1200/300' WHERE id=4;
UPDATE volunteers SET avatar_url='https://i.pravatar.cc/150?img=5', banner_url='https://picsum.photos/seed/v5/1200/300' WHERE id=5;
UPDATE volunteers SET avatar_url='https://i.pravatar.cc/150?img=6', banner_url='https://picsum.photos/seed/v6/1200/300' WHERE id=6;
UPDATE volunteers SET avatar_url='https://i.pravatar.cc/150?img=7', banner_url='https://picsum.photos/seed/v7/1200/300' WHERE id=7;
UPDATE volunteers SET avatar_url='https://i.pravatar.cc/150?img=8', banner_url='https://picsum.photos/seed/v8/1200/300' WHERE id=8;
UPDATE volunteers SET avatar_url='https://i.pravatar.cc/150?img=9', banner_url='https://picsum.photos/seed/v9/1200/300' WHERE id=9;
UPDATE volunteers SET avatar_url='https://i.pravatar.cc/150?img=10', banner_url='https://picsum.photos/seed/v10/1200/300' WHERE id=10;

-- Avatares y banners para organizaciones
UPDATE organizations SET avatar_url='https://picsum.photos/seed/org1/200/200', banner_url='https://picsum.photos/seed/org1b/1400/350' WHERE id=1;
UPDATE organizations SET avatar_url='https://picsum.photos/seed/org2/200/200', banner_url='https://picsum.photos/seed/org2b/1400/350' WHERE id=2;
UPDATE organizations SET avatar_url='https://picsum.photos/seed/org3/200/200', banner_url='https://picsum.photos/seed/org3b/1400/350' WHERE id=3;
UPDATE organizations SET avatar_url='https://picsum.photos/seed/org4/200/200', banner_url='https://picsum.photos/seed/org4b/1400/350' WHERE id=4;
UPDATE organizations SET avatar_url='https://picsum.photos/seed/org5/200/200', banner_url='https://picsum.photos/seed/org5b/1400/350' WHERE id=5;
